...
/*            padding-top: 7px;
        ...
        <script>
            ...
            var hello = "halli hallo";
            $.ajax({
                type: "POST",
                url: "positions.php",
                data: { name: "John", location: "Boston", id: hello }
            })
            //     .done(function( msg ) {
...
?>
        <div id="maincontainer">
            <div class="icontest">
            <img id="icon_grumpycat" class="desktopicon draggable" src="img/icon_grumpycat.png" alt="Grumpy Cat desktop icon">
            </div>
            <img id="icon_doge" class="desktopicon draggable" src="img/icon_doge.png" alt="Doge desktop icon">
            <img id="icon_revengebaby" class="desktopicon draggable" src="img/icon_revengebaby.png" alt="Revenge baby desktop icon">
